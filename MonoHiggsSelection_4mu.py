...
if __name__ == "__main__":
  ...
  h1pfmet_TTV.Sumw2()
  h1D_TTV.Sumw2()
  f1 = TFile.Open("/lustre/cms/store/user/defilip/MonoHiggs/80X/histos4mu_25ns/output_ZX_4mu_data_step10.root")
  ...
  print 'Sample name ' + args.channel + 'channel: ' + '/lustre/cms/store/user/defilip/MonoHiggs/80X/histos4mu_25ns/output_ZX_4mu_data_step10.root' + ' N Entries: ' + str(h1pfmet_ZX.GetEntries()) + ' Yield: ' + str(h1pfmet_ZX.Integral()) + ' Error: ' + str(math.sqrt(err2_ZX))  
  ...
  for f in flist:
    ...
    if "600_MA0" in name:
      ...
      #print 'Get the Entries BEFORE RESCALING:'
      #print hs_rebin.GetEntries()
      hs_rebin.Scale(1.7*0.122062931995/integral)
      hs_rebin.Write(name)
      ...
      #print 'Get the Entries BEFORE RESCALING:'
      #print hs_rebin.GetEntries()
      hs_rebin.Scale(1.7*0.0948640513867/integral)
      hs_rebin.Write(name)
      #print 'Do the integral AFTER RESCALING:'
      #print hs_rebin.Integral()
      rescal_integral=hs_rebin.Integral()
      ...
      #print 'Get the Entries BEFORE RESCALING:'
      #print hs_rebin.GetEntries()
      hs_rebin.Scale(1.7*0.0534612961063/integral)
      hs_rebin.Write(name)
      #print 'Do the integral AFTER RESCALING:'
      #print hs_rebin.Integral()
      rescal_integral=hs_rebin.Integral()
      ...
      #print 'Get the Entries BEFORE RESCALING:'
      #print hs_rebin.GetEntries()
      hs_rebin.Scale(1.7*0.0295065004725/integral)
      hs_rebin.Write(name)
      #print 'Do the integral AFTER RESCALING:'
      #print hs_rebin.Integral()
      rescal_integral=hs_rebin.Integral()
      ...
      #print 'Get the Entries BEFORE RESCALING:'
      #print hs_rebin.GetEntries()
      hs_rebin.Scale(1.7*0.0174091218485/integral)
      hs_rebin.Write(name)
      #print 'Do the integral AFTER RESCALING:'
      #print hs_rebin.Integral()
      rescal_integral=hs_rebin.Integral()
      ...
      #print 'Get the Entries BEFORE RESCALING:'
      #print hs_rebin.GetEntries()
      hs_rebin.Scale(1.7*0.00731307904519/integral)
      hs_rebin.Write(name)
      #print 'Do the integral AFTER RESCALING:'
      #print hs_rebin.Integral()
      rescal_integral=hs_rebin.Integral()
      ...
      #print 'Get the Entries BEFORE RESCALING:'
      #print hs_rebin.GetEntries()
      hs_rebin.Scale(1.7*0.00298383092001/integral)
      hs_rebin.Write(name)
      #print 'Do the integral AFTER RESCALING:'
      #print hs_rebin.Integral()
      rescal_integral=hs_rebin.Integral()
      ...
      #print 'Get the Entries BEFORE RESCALING:'
      #print hs_rebin.GetEntries()
      hs_rebin.Scale(1.7*0.00025617234348/integral) 
      hs_rebin.Write(name)
      #print 'Do the integral AFTER RESCALING:'
      #print hs_rebin.Integral()
      rescal_integral=hs_rebin.Integral()
