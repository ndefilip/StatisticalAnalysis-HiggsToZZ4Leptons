...
if __name__ == "__main__":
  ...
  h1pfmet_TTV.Sumw2()
  h1D_TTV.Sumw2()
  f1 = TFile.Open("/lustre/cms/store/user/defilip/MonoHiggs/80X/histos4e_25ns/output_ZX_4e_data_step10.root")
  ...
  print 'Sample name ' + args.channel + 'channel: ' + '/lustre/cms/store/user/defilip/MonoHiggs/80X/histos4e_25ns/output_ZX_4e_data_step10.root' + ' N Entries: ' + str(h1pfmet_ZX.GetEntries()) + ' Yield: ' + str(h1pfmet_ZX.Integral()) + ' Error: ' + str(math.sqrt(err2_ZX))  
